...
export type IRequireExternalFunctionKeyForGenerateJSLinesForRXInjectContent =
  | IRequireNodeAppendChildKey
  | IRequireCreateReactiveContentNodeKey
  | IRequireToObservableKey
  ;

export function generateJSLinesForRXInjectContent(
  content: string,
  requireExternalFunction: IRequireExternalFunction<IRequireExternalFunctionKeyForGenerateJSLinesForRXInjectContent>,
): ILines {
