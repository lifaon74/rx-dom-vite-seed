...
// @ts-ignore
import html from './mat-form-field.component.html?raw';
// @ts-ignore
import style from './mat-form-field.component.scss?inline';
...
export const MatFormFieldComponent = createMatButtonComponent({
  name: 'mat-button',
});
